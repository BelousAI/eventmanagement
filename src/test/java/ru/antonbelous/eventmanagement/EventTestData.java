...
public class EventTestData {
    ...
    public static final Event EVENT1 =  new Event(EVENT1_ID, of(2020, Month.APRIL, 28, 9, 0), "Позвонить заведующей аптеки", Status.PLANNED);
    public static final Event EVENT2 =  new Event(EVENT1_ID + 1, of(2020, Month.APRIL, 29, 11, 0), "Встреча с доктором Петровой В.В.", Status.PLANNED);
    public static final Event EVENT3 =  new Event(EVENT1_ID + 2, of(2020, Month.APRIL, 29, 14, 0), "Подписание договора", Status.CANCELED);
    ...
    public static final Event EVENT5 =  new Event(EVENT1_ID + 4, of(2020, Month.APRIL, 20, 13, 30), "Отгрузка товара", Status.FINISHED);
    public static final Event EVENT6 =  new Event(EVENT1_ID + 5, of(2020, Month.APRIL, 23, 9, 30), "Позвонить заведующему клиники", Status.FINISHED);
    public static final Event EVENT7 =  new Event(EVENT1_ID + 6, of(2020, Month.APRIL, 17, 18, 0), "Начало отпуска", Status.CANCELED);
